...
//TODO: Красивое TUI(Bubble Tea)
//TODO: Графики для метрик
//TODO: Сбор метрик с сенсоров(например, температуры)
//TODO: Caddy на сервере для обращения без порта 
//TODO: unit-тесты?
//TODO: Сделать меньше хардкода, больше констант